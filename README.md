...
**These ratings are not yet a ranking.** <!-- census:begin n-rated -->2510<!-- census:end n-rated --> entries have a rating,
...
therefore uneven, and that unevenness is the finding: <!-- census:begin n-onematch -->1689<!-- census:end n-onematch --> of the
<!-- census:begin n-rated -->2510<!-- census:end n-rated --> rated entries have exactly one comparison, so ratings sit on a few discrete
values and pile up at each end of the range.

<!-- census:begin rating-bands -->
| Band | Rating range | Entries | Mean matches |
| --- | --- | --- | --- |
| top band | 1508–1603 | 1090 | 1.5 |
| second band | 1500–1506 | 243 | 1.7 |
| third band | 1492–1498 | 885 | 1.1 |
| bottom band | 1427–1489 | 292 | 3.0 |
